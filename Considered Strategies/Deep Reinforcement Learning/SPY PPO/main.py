...
"""
This algorithm displays experimentation with a deep learning PPO model trained on a selection of technical indciators for the SPY ETF.
It is not the exact QQQ PPO variant explain in the IQP report. 
Over the backtest period, this algorithm does not trade often but is able to obtain an 81% win rate and a 0.378 Sharpe. 
"""
